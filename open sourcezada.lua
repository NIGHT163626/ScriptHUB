...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Poison/Scripts Hub"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Poison/Scripts Hub"
    ...
    local LabelFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
        Size = UDim2.new(1, 0, 0, 50),  -- Aumentado para 50 de altura
        BackgroundTransparency = 0.7,
        Parent = ItemParent
    }), {
        AddThemeObject(SetProps(MakeElement("Label", Text, 20), {  -- Aumentado o tamanho do texto para 20
            Size = UDim2.new(1, -12, 1, 0),
            Position = UDim2.new(0, 12, 0, 0),
            Font = Enum.Font.GothamBold,
            Name = "Content"
...
function ElementFunction:AddParagraph(Text, Content)
    ...
    local ParagraphFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
        ...
        AddThemeObject(SetProps(MakeElement("Label", Text, 20), {  -- Aumentado o tamanho do título para 20
            Size = UDim2.new(1, -12, 0, 14),
            Position = UDim2.new(0, 12, 0, 10),
            Font = Enum.Font.GothamBold,
            Name = "Title"
        }), "Text"),
        AddThemeObject(SetProps(MakeElement("Label", "", 15), {  -- Aumentado o tamanho do conteúdo para 15
 ...
 ElementFunction:AddButton(ButtonConfig)
